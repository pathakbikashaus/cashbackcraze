...
const About = () => {
  return (
    <div className="min-h-screen py-8">
      <h1 className="text-4xl font-bold text-primary-blue mb-6 text-center">About CashbackCraze</h1>
      ...
      <div className="mt-12 text-center">
        <h2 className="text-3xl font-bold text-accent-green mb-4">Our Mission</h2>
