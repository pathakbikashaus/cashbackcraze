...
const Index = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-primary-blue to-blue-700 text-white py-20 md:py-32 text-center overflow-hidden">
        <div className="container mx-auto relative z-10">
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 text-highlight-yellow drop-shadow-lg">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link to="/deals">
              <Button variant="outline" className="bg-white text-primary-blue hover:bg-gray-100 text-lg px-8 py-3 rounded-full shadow-lg transform hover:scale-105 transition-transform duration-300">
                Explore Deals
              </Button>
            </Link>
          </div>
        ...
        <div className="absolute bottom-0 left-0 w-full bg-highlight-yellow bg-opacity-20 py-2 text-sm md:text-base animate-pulse">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-100 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-5xl text-accent-green mb-4">🎟️</div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-100 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-5xl text-highlight-yellow mb-4">💰</div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-100 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-5xl text-primary-blue mb-4">🤝</div>
